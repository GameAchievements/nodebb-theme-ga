<div class="container-fluid hero-user align-items-center">
</div>
...
<div class="account w-100 mx-auto">
	...
	<div class="d-flex flex-column flex-md-row gap-2 w-100 pb-4 mb-4 mt-2 border-bottom user-header-container">
